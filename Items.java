...
public class Items extends Player_Interface
{
    ...
    int itemID = 0;
    boolean synchronized_items_df = false;
    public void act() 
    {
            if (!(iDF)){
            ...
            if (itemID < 223) {
                ...
                if (!(synchronized_items_df))
                {
                    System.out.println("Loading Items... - This may take a moment!");
                    synchronized_items_df = true;
                } 
                
                else if (synchronized_items_df)
                
                {
                    
                    System.out.println("Item_" + data[itemID]);
                    GreenfootImage itemImg = new GreenfootImage("Item_" + data[itemID] + ".png");
                    setImage(itemImg);
                    itemImg.scale(itemImg.getWidth()*6,itemImg.getHeight()*6);
                    itemID=itemID+1;
