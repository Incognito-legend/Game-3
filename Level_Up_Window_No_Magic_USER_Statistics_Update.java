...
GreenfootSound LVL_UP_STAT_WINDOW_Sound;
    public int Level_UP_STAT_Window_Instance(int instance){ 
    //start v
    //switch stage - non-regular level up - change to magic/non-magic class, set player level to 1 again subtract int exp to 0.
        if (instance == 1){
